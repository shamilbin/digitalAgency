...
const Services = () => {
  ...
  return (
    <div id='services' className='relative flex flex-col  sm:px-12
1g:px-24 xl:px-40 items-center gap-7 px-4 pt-30 text-gray-700 dark:text-white '>
      ...
      <Title title='How can we help?' desc='For Strategy to execution , we craft digital solution that move your business forward.'/>
