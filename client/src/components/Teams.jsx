...
const Teams = () => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      id="team"
      className="flex flex-col items-center gap-4 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-800 dark:text-white"
    >
      <Title
        title="Meet the team "
        desc="A passionate team of digital expert dedicate to your brand success"
      />
